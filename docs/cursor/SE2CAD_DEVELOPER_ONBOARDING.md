...
4. The current program charter named by STATE (currently [SE2CAD_PROGRAM_M7.md](../technical/governance/SE2CAD_PROGRAM_M7.md))
5. The selected unit in the plan STATE names (currently [SE2CAD_PLAN_M7.md](../technical/governance/SE2CAD_PLAN_M7.md))
...
| Current program objective, exclusions, end state | [SE2CAD_PROGRAM_M7.md](../technical/governance/SE2CAD_PROGRAM_M7.md) |
| Current bounded unit definitions (no live status) | [SE2CAD_PLAN_M7.md](../technical/governance/SE2CAD_PLAN_M7.md) |
| Historical initial program (complete) | [SE2CAD_PROGRAM.md](../technical/governance/SE2CAD_PROGRAM.md), [SE2CAD_PLAN.md](../technical/governance/SE2CAD_PLAN.md) |
