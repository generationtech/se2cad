...
- Core parser, catalog, IR, transforms, library, statistics, preflight, and conversion policy stay CAD-backend-neutral. SolidWorks is the first backend, not the name of the core.
