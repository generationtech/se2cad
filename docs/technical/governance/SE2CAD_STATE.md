...
Public capability text in [README.md](../../../README.md) matches the qualified initial capability plus QUALIFIED S2C-7.1.1 blueprint statistics, QUALIFIED S2C-8.1.1 component names, QUALIFIED S2C-9.1.1 CAD-neutral `ColorMaskHSV` appearance, QUALIFIED S2C-9.2.1 per-instance SolidWorks component appearance, QUALIFIED S2C-10.1.1 optional block-edge treatment contract, QUALIFIED S2C-10.2.1 optional treated canonical parts, QUALIFIED S2C-10.3.1 explicit treated-part assembly selection, QUALIFIED S2C-10.4.1 configurable demand-driven chamfer variants, QUALIFIED S2C-11.1.1 operator-local definition discovery, QUALIFIED S2C-11.2.1 catalog identity expansion, QUALIFIED S2C-11.3.1 geometry provenance and recipe selection, QUALIFIED S2C-11.4.1 automated generation of the representative heavy-armor subset, QUALIFIED S2C-11.5.1 leftover/long-tail exception workflow and expansion regression, QUALIFIED S2C-11.6.1 demand-driven qualified base-part materialization, QUALIFIED S2C-12.1.1 conversion preflight, QUALIFIED S2C-12.2.1 strict and permissive unknown-block conversion, QUALIFIED S2C-12.3.1 vanilla object-builder parser compatibility, QUALIFIED S2C-12.4.1 safe assembly filename derivation, and QUALIFIED S2C-11.7.1 single-identity SDK-FBX materialization of `LargeBlockSmallHydrogenThrust`, QUALIFIED S2C-11.8.1 demand-driven vanilla TriangleMesh resolution for eligible Large Grid 1×1×1 blocks, QUALIFIED S2C-11.9.1 ASCII SDK-FBX conversion support for those already-eligible identities, QUALIFIED S2C-11.10.1 CAD-neutral multi-cell placement metadata and occupancy-center transform foundation, and QUALIFIED S2C-11.11.1 demand-driven Large Grid multi-cell TriangleMesh materialization and occupancy-center placement, and QUALIFIED S2C-11.12.1 real-blueprint compatibility survey and next-gap classification, and QUALIFIED S2C-11.13.1 planar CubeTopology native constructions, and QUALIFIED S2C-11.14.1 remaining planar CubeTopology geometry reconstruction study, and QUALIFIED S2C-11.15.1 definition-parse and empty-subtype compatibility cleanup, and QUALIFIED S2C-11.16.1 multi-node SDK FBX frame preservation. Eligible Large Grid vanilla TriangleMesh identities whose definition Size is larger than 1×1×1 may resolve, materialize, and place through the existing demand-driven path; that is not universal vanilla or universal FBX support. When an imported parentless mesh is origin-local while its node translation is non-zero and the combined imported world of that root plus descendants is displaced, descendant world translations subtract that parent translation before join. Combined-origin-local multi-node files are left unchanged. That is not a name heuristic and is not a claim that every real-ship alignment defect is fixed. Targeted lookup may accept evidenced child X/Y/Z Size/ModelOffset and coalesce identical duplicate BlockTopology scalars. A bounded vanilla empty-subtype resolution rule is supported when the object-builder type and Large Grid context uniquely identify an exact empty-SubtypeId vanilla definition; that is not general empty-subtype support. A qualified subset of Large Grid planar CubeTopology identities is supported through native procedural constructions; CubeTopology as a class is not supported. Generated parts and assemblies remain local cache; live SolidWorks 2026 end-to-end qualification of the acceptance fixture is recorded only here. STATE does not claim universal vanilla support. Remaining later M13 units through M15 are approved, not implemented. S2C-13.1.1 is postponed.

## Next executable unit

None. S2C-11.16.1 is QUALIFIED. S2C-13.1.1 Small Grid semantic path remains PLANNED and is postponed by explicit human authorization. Do not start it unless the human later directs that. Do not invent a later curved CubeTopology unit, CubeTopology mesh-characterization unit, Small Grid work, general SDK-mesh support, a whole vanilla catalog, OBJ export, multi-grid, symmetry, print-shell, or later units. Universal vanilla blueprint compatibility is not claimed. Universal FBX support is not claimed. CubeTopology as a class is not claimed. Empty subtypes are not generally supported. Universal real-ship mesh alignment is not claimed.
...
| S2C-11.10.1 | QUALIFIED | CAD-neutral Size/ModelOffset placement metadata and occupancy-center transform. Ordinary suite 627 tests, 12 skipped, OK excluding untracked Small Grid WIP. Acceptance 1×1×1 transforms unchanged. Multi-cell identities remain runtime-ineligible. Big Red read-only 136/126/10/0/10; expected future translations recorded under gitignored `tmp/generated/s2c-11.10.1/`. No multi-cell CAD generated. Distinct assessment [below](#qualitysecurity-assessment-s2c-11101). |
| S2C-11.11.1 | QUALIFIED | Demand-driven Large Grid multi-cell TriangleMesh materialization and occupancy-center placement. Ordinary suite 649 tests, 12 skipped, OK excluding untracked Small Grid WIP. Big Red permissive 136/136/0/0/0; existing 126 components unchanged; ten formerly-filler instances use qualified occupancy-center poses and five reusable official-SDK SLDPRTs. Packaged catalog still 9 entries. Distinct assessment [below](#qualitysecurity-assessment-s2c-11111). |
| S2C-11.12.1 | QUALIFIED | Real-blueprint compatibility survey of official Prefab `Eco_Ship_RST6Salvador` (SHA-256 `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`): 1,237 blocks / 183 identities; supported 725 (58.61%; packaged 219 / runtime 506); unknown unresolved 512 (41.39%); unsupported known 0. Dominant cause `CUBETOPOLOGY_NOT_SUPPORTED` 493 / 19 (96.29% of unresolved). Ordinary suite 662 tests, 12 skipped, OK excluding untracked Small Grid WIP. Big Red remains 136/136/0/0/0. No compatibility category newly activated. Packaged catalog still 9 entries. Distinct assessment [below](#qualitysecurity-assessment-s2c-11121). |
| S2C-11.13.1 | QUALIFIED | Native procedural Slope2Base / Slope2Tip / HalfBox constructions bound to `LargeBlockArmorSlope2Base`, `LargeBlockArmorSlope2Tip`, `LargeHalfArmorBlock`, and `LargeHeavyHalfArmorBlock`. Salvador survey 1,237 / supported 1,027 (83.02%; packaged 521 / runtime 506) / unknown 210. RoundSlope 44 and RoundCorner 32 remain unresolved. Ordinary suite 685 tests, 15 skipped, OK excluding untracked Small Grid WIP. Live SW 2026 `RevisionNumber` 34.3.2 generated/reopened the four parts and assembled a 6-block targeted fixture. Big Red remains 136/136/0/0/0. Packaged catalog 13 entries. Distinct assessment [below](#qualitysecurity-assessment-s2c-11131). |
| S2C-11.14.1 | QUALIFIED | Remaining planar CubeTopology geometry reconstruction study. No new block identity gained runtime support. Packaged catalog unchanged at 13 entries. Existing four S2C-11.13.1 identities remain the only newly qualified planar CubeTopology support from that prior unit. All 13 remaining non-curved identities are `NEEDS_MORE_EVIDENCE` (0 PROVEN additional instances). RoundSlope 44 and RoundCorner 32 remain `OUT_OF_SCOPE` curved. Salvador re-survey 1,237 / supported 1,027 (83.02%) / unknown 210. Ordinary suite 685 tests, 15 skipped, OK excluding Small Grid WIP. Big Red remains 136/136/0/0/0. Durable report [S2C-11.14.1_REMAINING_PLANAR_CUBETOPOLOGY_GEOMETRY.md](../surveys/S2C-11.14.1_REMAINING_PLANAR_CUBETOPOLOGY_GEOMETRY.md). Distinct assessment [below](#qualitysecurity-assessment-s2c-11141). |
| S2C-11.15.1 | QUALIFIED | Definition-parse and empty-subtype compatibility cleanup. Child X/Y/Z Size/ModelOffset and identical `BlockTopology` coalescing unblocked `LadderShaft`, `LargeBlockConsoleModule`, `LargeBlockInsetWall`, and `LargeBlockSciFiWall`. Bounded empty-subtype resolution unblocked Large empty `GravityGenerator`, `OxygenTank`, and `OxygenGenerator`. Salvador 1,237 / supported 1,046 (84.56%; packaged 521 / runtime 525) / unknown 191, all `CUBETOPOLOGY_NOT_SUPPORTED` (115 planar + 76 curved). Packaged catalog still 13. Ordinary suite 723 tests, 19 skipped, OK excluding Small Grid WIP (one new skipped live integration test). Big Red 136/136/0/0. Live SW 2026 `RevisionNumber` 34.3.2 8-block targeted fixture: 8/8 supported, 0 fillers, seven distinct geometry IDs generated then reused, repeated `LadderShaft` shared one SLDPRT, occupancy-center OxygenTank/OxygenGenerator, save/reopen, warm run generated none. Distinct assessment [below](#qualitysecurity-assessment-s2c-11151). |
| S2C-11.16.1 | QUALIFIED | Multi-node official SDK FBX frame preservation. Blender all-world join of a baked parent geometric translation produced a second displaced RemoteControl hull; occupancy/ModelOffset/IR/Transform2 were already correct. Production rule neutralizes inherited parent translation only when the parentless mesh is origin-local and substantial and the imported combined world of that root plus descendants is displaced. HydrogenTank combined-origin-local 3×3×3 is left unchanged. Ordinary suite 737 tests, 20 skipped, OK excluding Small Grid WIP. Salvador 1,237 / 1,046 / 191 / 84.56% CubeTopology only. Big Red preflight 136/136/0/0; isolated assemble 136 components; RemoteControl part ±1.25 m and Transform2 matches IR. Distinct assessment [below](#qualitysecurity-assessment-s2c-11161). |
...
### 2026-09-11 — S2C-11.16.1 QUALIFIED

Human-authorized bounded research/remediation for the real-ship SDK-mesh local-frame problem proven by S2C-DIAG-REALSHIP-ALIGNMENT-1. Did not start another roadmap unit. Did not change occupancy-center, ModelOffset, blueprint/IR rotation, or assembly Transform2. Did not suppress the SolidWorks facet-normal warning. Did not expand CubeTopology, Small Grid, or OBJ. Did not special-case RemoteControl by name. Did not commit, tag, push, or deploy. Did not commit Keen assets or generated CAD. Next executable unit remains none.

Checkpoint: `main` at `fa667f4fb2ab98926699c81ebc087aee68070809` (S2C-11.15.1 QUALIFIED). Working tree was clean.

Root cause: official SDK FBX files may carry a parent Geometric/object-offset translation that applies only to that node's own mesh. Blender folds that transform into the object matrix, so `bpy.ops.object.transform_apply` plus join of every mesh concatenates a world-centered parent hull with children that inherited the parent translation. `LargeBlockRemoteControl` parent mesh is already ±1.25×1.0×1.0 m in model frame while node T≈(1.272, 0.478, 0.610) m; the old join extended to +2.522 m. Battery parent T=0 on the same path, so it stayed correct.

Selected rule (CAD-neutral `inherited_root_translations_to_neutralize`): neutralize descendant world translations by a parentless mesh translation only when that parent mesh is origin-local and substantial (longest axis ≥ 0.5 m) and the imported combined world of that root plus descendants is displaced from the origin. Combined-origin-local files, ordinary translation-local files, FrontLight-style partial offsets, tiny roots, and T≈0 roots are left unchanged. Duplicate mesh names or conflicting descendant corrections fail closed.

First-draft rule without the combined-world guard wrongly shifted `LargeHydrogenTank` children by (0,0,-3.75) m (combined world was already ±3.86 m). Remediated; tank after-fix size ≈7.72×7.57×7.72 m, neutralized count 0. RemoteControl remains 20 neutralized children and ≈2.50 m cube.

Live SW 2026 `RevisionNumber` 34.3.2. Targeted generate under `C:\SE2CAD-generated\s2c-11.16.1-live`: RemoteControl 438,389 bytes, Battery 587,180, Symbol B 212,045, FrontLight 705,106. FrontLight `LoadFile2` took ~33 minutes after `SE2CAD_STL_IMPORT geometry_id=vanilla_lg_1x1x1_large_block_front_light`; no titled warning dialog; warning was not suppressed. First unittest then failed on `CanonicalBlock.transform` (no such field); remediates to `rotation`/`position_mm` and source_index matching. Continue assemble/warm reused all four; document count 0→0; Transform2 matches IR via production `assert_assembly_matches`. Part boxes: RemoteControl ±1.25 m; Battery/FrontLight origin-centered; Symbol B face-local.

Big Red from isolated `C:\SE2CAD-generated\s2c-11.16.1-bigred`: preflight 136/136/0/0; assemble 136 components to `Big_Red+ffe1ed5b9381.SLDASM` (15,356,406 bytes). RemoteControl, Battery×2, FrontLight×8, Camera×4, SmallContainer×4, Symbol B×2, and HydrogenTank Transform2 each match IR. RemoteControl part-local box remains ±1.25 m.

Ordinary suite excluding `tests/test_small_grid.py`, roots and `SE2CAD_SOLIDWORKS_INTEGRATION` unset, Blender set for host tests: 737 collected, 20 skipped, OK. Salvador SHA-256 `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`: 1,237 / supported 1,046 (84.56%) / unknown 191, all `CUBETOPOLOGY_NOT_SUPPORTED`. Distinct assessment [below](#qualitysecurity-assessment-s2c-11161).

### 2026-09-11 — S2C-11.15.1-LIVE QUALIFIED

Human-authorized bounded live qualification closure for already DEV-COMPLETE S2C-11.15.1. Did not begin another compatibility unit. Did not expand CubeTopology. Did not start Small Grid. Did not add OBJ. Did not alter the seven-identity support contract. Did not commit, tag, push, or deploy. Did not commit Keen assets or generated CAD. Next executable unit remains none.

Checkpoint: `main` at `c90ce58ea101c4a502f725a0b92dd52da574a837` (S2C-11.14.1 QUALIFIED). S2C-11.15.1 implementation changes were already present and uncommitted; this session added only the targeted live test and this evidence. No unrelated edits were introduced.

Live SW 2026 `RevisionNumber` 34.3.2. `GetActiveObject` failed on the already-running host; `Dispatch` attached (`started_application=true`) to PID 2716. Document count 0 before and after. Session-scoped graphics-body STL import preferences were exercised and restored to the start snapshot.

Targeted fixture `tests/test_solidworks_integration.py::SolidWorksIntegrationTests::test_definition_parse_cleanup_targeted_fixture_assembles_and_reuses` (in-test 8-block Large Grid SBC). Inventory: `LadderShaft` (0,0,0) and repeated `LadderShaft` (4,0,0); rotated `LargeBlockConsoleModule` (0,4,0) Forward=Right/Up=Up; `LargeBlockInsetWall` (8,0,0); `LargeBlockSciFiWall` (0,0,4); empty `GravityGenerator` (8,4,0); empty `OxygenTank` (4,2,8); empty `OxygenGenerator` (8,0,8). Preflight 8/8/0/0; convert fillers 0.

Resolved identities / geometry IDs from production resolution:

| Identity | geometry_id | first-run SLDPRT bytes |
| --- | --- | --- |
| `LadderShaft` | `vanilla_lg_1x1x1_ladder_shaft` | 1,135,411 |
| `LargeBlockConsoleModule` | `vanilla_lg_1x1x1_large_block_console_module` | 978,145 |
| `LargeBlockInsetWall` | `vanilla_lg_1x1x1_large_block_inset_wall` | 637,858 |
| `LargeBlockSciFiWall` | `vanilla_lg_1x1x1_large_block_sci_fi_wall` | 953,975 |
| empty `GravityGenerator` | `vanilla_lg_1x1x1_empty_gravity_generator` | 1,016,936 |
| empty `OxygenTank` | `vanilla_lg_empty_oxygen_tank` | 1,029,924 |
| empty `OxygenGenerator` | `vanilla_lg_empty_oxygen_generator` | 1,484,222 |

First run under isolated `C:\SE2CAD-generated\s2c-11.15.1-live` (not seeded): generated all seven IDs, reused none. Repeated `LadderShaft` shared one part file. Assembly `se2cad-defparse-probe.SLDASM` (2,888,085 bytes) had 8 components; IR transforms, names, colors, det +1; OxygenTank/OxygenGenerator translations were occupancy-center, not Min-cell. Save/close/reopen succeeded; reopened count 8 with matching transforms and part references. Warm second run: generated none, reused all seven; same 8 components/transforms/names/colors; save/reopen succeeded. No blocking modal. Document count returned to 0.

Production import path validated each new part (file exists, SolidWorks consumed it, graphics-body envelope, finite plausible box). An extra post-assemble OpenDoc sweep of all seven parts caused `RPC_E_DISCONNECTED` and was removed from the test; envelope evidence stays the production generate/reopen path.

Focused `tests/test_definition_parse_cleanup.py`: 36 passed with operator roots. Shared live `test_representative_automatable_parts_generate_validate_save_and_reopen`: 1 passed in 7.86 s. Ordinary suite excluding `tests/test_small_grid.py`, roots and `SE2CAD_SOLIDWORKS_INTEGRATION` unset: 704 passed, 19 skipped, 184 subtests passed, 0 failures (723 collected; the new live test is the extra skip).

Salvador survey (same SHA-256 `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`): 1,237 / supported 1,046 (84.56%; packaged 521 / runtime 525) / unknown 191, all `CUBETOPOLOGY_NOT_SUPPORTED` (115 planar + 76 curved). No parse-gap or empty-subtype unknowns. Big Red preflight 136 / 136 / 0 / 0 / `all_supported=true`.

### 2026-09-11 — S2C-11.15.1 QUALIFIED

Human-authorized definition-parse and empty-subtype compatibility cleanup after S2C-11.14.1 was QUALIFIED and committed (`c90ce58ea101c4a502f725a0b92dd52da574a837`) and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not implement CubeTopology. Did not implement RoundSlope or RoundCorner. Did not add OBJ. Did not add generic subpart/animation/mechanical support. Did not bulk-expand the packaged catalog. Did not invent or begin a later implementation unit. Did not commit, tag, or push. Did not commit Keen assets or generated CAD.

S2C-11.14.1 checkpoint was safely separated: working tree was clean on `main` at that HEAD before this unit began.

Parse-gap identities (all Large, TriangleMesh, 1×1×1, no subparts, unique official SDK binary FBX):

| Identity | Definition file | Parse pattern | Model |
| --- | --- | --- | --- |
| `LadderShaft` | `CubeBlocks_Interiors.sbc` | child X/Y/Z Size and ModelOffset | `Models\Cubes\large\LadderShaft.mwm` |
| `LargeBlockConsoleModule` | `CubeBlocks_SignalsPack.sbc` | two identical `BlockTopology` TriangleMesh | `Models\Cubes\Large\ConsoleModuleStraight.mwm` |
| `LargeBlockInsetWall` | `CubeBlocks_SignalsPack.sbc` | two identical `BlockTopology` TriangleMesh | `Models\Cubes\Large\InsetWallStraight.mwm` |
| `LargeBlockSciFiWall` | `CubeBlocks_SparksOfTheFuturePack.sbc` | two identical `BlockTopology` TriangleMesh | `Models\Cubes\Large\SciFiWall.mwm` |

Empty-subtype builders (exactly one Large empty-SubtypeId definition each; non-empty and Small variants exist and are not used):

| Blueprint `xsi:type` | TypeId | Size | Model | geometry_id |
| --- | --- | --- | --- | --- |
| `MyObjectBuilder_GravityGenerator` | GravityGenerator | 1×1×1 | `GravityGenerator.mwm` | `vanilla_lg_1x1x1_empty_gravity_generator` |
| `MyObjectBuilder_OxygenTank` | OxygenTank | 1×2×1 | `OxygenStorage.mwm` | `vanilla_lg_empty_oxygen_tank` |
| `MyObjectBuilder_OxygenGenerator` | OxygenGenerator | 1×2×1 | `OxygenGenerator.mwm` | `vanilla_lg_empty_oxygen_generator` |

Identity representation: `ParsedBlock.subtype_id` stays `""`; catalog runtime `subtype_id` stays the actual empty vanilla SubtypeId; placement key is internal `empty-type/{TypeId}`; survey/preflight display key is `(empty SubtypeName)/{builder}` only.

Salvador SHA-256 unchanged `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`. Baseline 1,027/1,237 (83.02%). Final 1,046/1,237 (84.56%). Instance gain +19. Identity gain +7. Residual unknown 191 = CubeTopology only.

Ordinary suite excluding `tests/test_small_grid.py`, with `SE2CAD_GAME_ROOT` / `SE2CAD_SDK_ROOT` / `SE2CAD_SOLIDWORKS_INTEGRATION` unset: 722 tests, 18 skipped, OK.

Live SW 2026 `RevisionNumber` 34.3.2. Targeted fixture preflight was 8/8 supported. Implementation remediations: session-scoped graphics-body STL import preferences; envelope accepts a coherent graphics-body box. The first live assemble attempt generated `vanilla_lg_1x1x1_ladder_shaft.SLDPRT` and then appeared to hang on a later `LoadFile2`; later same-day S2C-11.15.1-LIVE evidence showed those imports complete if given minutes, and the full 8-block generate-then-reuse assemble plus warm reuse is recorded in the S2C-11.15.1-LIVE session above. No Keen assets or generated CAD were committed.

### 2026-09-11 — S2C-11.14.1 QUALIFIED

Human-authorized remaining planar CubeTopology geometry reconstruction study after S2C-11.13.1 was QUALIFIED and committed (`adefe3a2512aec16e27e8756704484f63e6dbddf`) and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not implement production CubeTopology support. Did not implement RoundSlope or RoundCorner. Did not add OBJ. Did not add generic subpart/animation/mechanical support. Did not bulk-expand the packaged catalog. Did not mutate leftover metadata. Did not add subtype-specific Salvador hacks. Did not invent or begin a later implementation unit. Did not commit, tag, or push. Did not commit Keen assets or generated CAD.

S2C-11.13.1 checkpoint was safely separated: working tree was clean on `main` at that HEAD before this unit began.

This QUALIFIED status means the geometry reconstruction study is complete. It does **not** mean remaining block identities gained support. The four S2C-11.13.1 identities remain the only newly qualified planar CubeTopology support from that prior unit.

Durable report: [S2C-11.14.1_REMAINING_PLANAR_CUBETOPOLOGY_GEOMETRY.md](../surveys/S2C-11.14.1_REMAINING_PLANAR_CUBETOPOLOGY_GEOMETRY.md).

Remaining Salvador non-curved CubeTopology inventory (115 instances / 13 identities) matches the authorized expected set. Local vanilla definitions were extracted for all 13 plus RoundSlope/RoundCorner. Public 2018 `MyCubeGridDefinitions.m_tileTable` contains StandaloneBox, RoundSlope, and RoundCorner as tile/connectivity rows and does **not** contain later tokens. Current ModAPI lists those later enum members; table bodies are unpublished. Local install has no game DLLs. Official construction FBX exists and is binary; it was classified, not imported, not bound, not decoded into vertices.

Classification: all 13 remaining non-curved identities `NEEDS_MORE_EVIDENCE`. RoundSlope and RoundCorner `OUT_OF_SCOPE` curved. PROVEN additional instances: 0. Hypothetical supported remains 1,027 / 83.02%. Remaining unknown 210 = 115 planar + 76 curved + 16 parser-gap + 3 empty-subtype.

Recommended later implementation boundary (not created, not executable): do not implement yet; evidence insufficient. Prefer a license-clear post-2018 vertex/topology source before any construction unit.

Salvador re-survey (same SHA-256 `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`): 1,237 / supported 1,027 / unknown 210 / `support_granted=false`.

Big Red preflight remains 136 / supported 136 / unknown 0 / unsupported 0 / `all_supported=true`.

Ordinary verification excluding tracked Small Grid WIP, with `SE2CAD_GAME_ROOT` / `SE2CAD_SDK_ROOT` / `SE2CAD_SOLIDWORKS_INTEGRATION` unset: 685 tests, 15 skipped, OK, 2.175 s. Production Python was not changed.

| Check | Result |
| --- | --- |
| Packaged catalog | 13 entries, unchanged |
| Leftover residual topologies | empty, unchanged |
| Runtime CubeTopology support added | none |
| RoundSlope / RoundCorner | still unresolved / not implemented |
| Small Grid / OBJ / subparts | postponed / absent / absent |
| Big Red preflight | 136 / 136 / 0 / 0 / `all_supported=true` |
| Ordinary suite | 685 tests, 15 skipped, OK (env unset; Small Grid WIP excluded) |
| Keen assets / generated CAD committed | none |
| Commit / tag / push / deploy | none |
| Next executable unit | none |

Distinct assessment [below](#qualitysecurity-assessment-s2c-11141).

### 2026-09-11 — S2C-11.13.1 QUALIFIED

Human-authorized planar CubeTopology native construction expansion after S2C-11.12.1 was QUALIFIED and committed (`9c9715baae8d2891f4bec498afb61bdbb07110ae`) and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not implement RoundSlope or RoundCorner. Did not add OBJ. Did not add generic subpart/animation/mechanical support. Did not bulk-expand the packaged catalog. Did not add subtype-specific Salvador hacks. Did not invent or begin a later unit. Did not commit, tag, or push. Did not commit Keen assets or generated CAD.

S2C-11.12.1 checkpoint was safely separated: working tree was clean on `main` at that HEAD before this unit began.

Vanilla Game Content definitions under `C:\SE2CAD-SE\Game\Content\Data\CubeBlocks` were inspected for every Salvador planar CubeTopology identity. Published Keen `MyCubeGridDefinitions` (2018) supplies Slope2Base/Slope2Tip tile tables; later tokens (HalfBox, HalfSlope*, SlopedCorner*, SlopeTransition*) are absent from that snapshot. Sides entries are mount/texture panels, not a complete solid grammar.

Construction families qualified:

| Family | Token | Identities | Salvador N | geometry_id | Volume ×6 | AABB |
| --- | --- | --- | ---: | --- | --- | --- |
| Slope2Base | `Slope2Base` | `LargeBlockArmorSlope2Base` | 180 | `large_block_armor_slope2_base` | `36 h³` | full cell |
| Slope2Tip | `Slope2Tip` | `LargeBlockArmorSlope2Tip` | 74 | `large_block_armor_slope2_tip` | `12 h³` | max Y = 0 |
| HalfBox | `HalfBox` | `LargeHalfArmorBlock`, `LargeHeavyHalfArmorBlock` | 38+10 | distinct IDs; shared construction | `24 h³` | max Y = 0 |

`h = LARGE_GRID_CELL_PITCH_MM // 2`. Light/heavy HalfBox share geometry and keep distinct catalog IDs. `chamfer_capable=true` (convex; existing treatment applies). Placement/occupancy-center formula unchanged. 24 legal rotations remain det +1.

Investigated and left unresolved: HalfSlopeInverted, HalfCorner, HalfSlopedCorner, SlopedCornerBase/Tip/SlopedCorner, SquareSlopedCornerBase, HalfSlopeBox (light+heavy), InteriorWall/`StandaloneBox` (omitted BlockTopology — not broadened globally), SlopeTransitionTip + Mirrored, RoundSlope, RoundCorner, Small Grid counterparts.

Salvador survey (same SHA-256 `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834`):

| Field | S2C-11.12.1 | S2C-11.13.1 |
| --- | ---: | ---: |
| Total | 1,237 | 1,237 |
| Supported instances | 725 | 1,027 |
| Supported unique | 157 | 161 |
| Packaged instances / unique | 219 / 4 | 521 / 8 |
| Runtime instances / unique | 506 / 153 | 506 / 153 |
| Unknown unresolved | 512 / 26 | 210 / 22 |
| Support % | 58.61 | 83.02 |
| CubeTopology instances / identities | 493 / 19 | 191 / 15 |
| RoundSlope / RoundCorner | 44 / 32 | 44 / 32 |
| Parse gaps / empty subtype | 16 / 3 | 16 / 3 |

Gain: +302 instances / +4 identities. Theoretical planar upper bound 1,142 / 92.32% was not forced; 115 remaining planar instances lack a confident construction.

Live SolidWorks 2026 `RevisionNumber` 34.3.2. A 16-hour host could NewDocument/SaveAs but `OpenDoc` returned None even for previously qualified parts; an empty-document `ExitApp` restored OpenDoc. Fresh host `started_application=true`. Four parts under `C:\SE2CAD-generated\s2c-11.13.1-parts`: one solid body each, volumes 11.71875 / 3.90625 / 7.8125 / 7.8125 m³, zero sheet bodies, reuse generated none. Targeted 6-block fixture under `s2c-11.13.1-fixture`: 6 components, 4 generated IDs then reuse none, generic IR translations/rotations det +1, names and colors, document count returned to baseline. No blocking modal.

Full Salvador SolidWorks assembly was not completed. An extracted 302-block planar IR (180+74+38+10, 0 fillers) materialized four parts and saved `se2cad-salvador-planar.SLDASM`; reopen collided with an accidental parallel integration-test session (`RPC server is unavailable`). Regenerating ~153 unseeded vanilla TriangleMesh parts for the full 1,237-block ship is outside this unit. Targeted fixture plus Salvador preflight are the acceptance evidence.

Big Red preflight remains 136 / supported 136 / unknown 0 / unsupported 0 / `all_supported=true`.

Ordinary verification excluding untracked Small Grid WIP, with `SE2CAD_GAME_ROOT` / `SE2CAD_SDK_ROOT` / `SE2CAD_SOLIDWORKS_INTEGRATION` unset: 685 tests, 15 skipped, OK, 2.138 s. Live definition evidence with game root configured: 1 test OK. Discovery tests error when a real SDK root without `Data/CubeBlocks` is left in the environment; that is pre-existing isolation, not a support grant.

| Check | Result |
| --- | --- |
| Packaged catalog | 13 entries (9 prior + 4 individually qualified) |
| Library native records | 12 |
| Default `generate_canonical_parts()` | original four |
| Leftover residual topologies | empty; Slope2Base/Tip/HalfBox completed |
| CubeTopology as a class | not supported |
| RoundSlope / RoundCorner | unresolved |
| Small Grid / OBJ / subparts | postponed / absent / absent |
| Big Red preflight | 136 / 136 / 0 / 0 / `all_supported=true` |
| Ordinary suite | 685 tests, 15 skipped, OK (env unset; Small Grid WIP excluded) |
| Keen assets / generated CAD committed | none |
...
Distinct assessment [below](#qualitysecurity-assessment-s2c-11131).

### 2026-09-11 — S2C-11.12.1 QUALIFIED

Human-authorized real-blueprint compatibility survey and next-gap classification after S2C-11.11.1 was QUALIFIED and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not grant new compatibility support. Did not start Small Grid. Did not expand CubeTopology. Did not add OBJ export, subpart/animation/mechanical support, MWM decoding, mod resolution, or a bulk catalog expansion. Did not invent or begin a later implementation unit. Did not commit, tag, or push. Did not commit Keen assets or generated CAD.

Qualification means the survey/classification is complete and reproducible. It does not mean additional block categories became supported.

Operator `C:\SE-blueprints` still contains only Big Red. Bounded inventory of official Prefabs already present under the configured game-content tree (`Data/Prefabs/CargoShips` and `Data/Prefabs/Economy/Sales` Eco_Ship_* only; no workshop scrape) found 34 single-grid Large Grid ships larger than Big Red. Primary survey document is official Prefab `Eco_Ship_RST6Salvador` (RST-6 Salvador).

| Field | Value |
| --- | --- |
| Source | `C:\SE2CAD-SE\Game\Content\Data\Prefabs\Economy\Sales\Eco_Ship_RST6Salvador.sbc` |
| Kind | Official Keen Prefab (not ShipBlueprint) |
| SHA-256 | `2f8b6bce30d9919d4ede9c83bd611200f3b41877150a01df87a6a2618d00f834` |
| Bytes | 742,549 |
| Grids | 1 Large; 0 mechanical groups; no Small Grid; no docked construct; no evidenced modded identities |
| Blocks | 1,237 |
| Structural unique SubtypeIds | 181 |
| Survey unique identities | 183 |
| Cell extents (Min span) | x[-6..18] y[-6..5] z[-9..9] |
| Dimensions mm | 62,500 × 30,000 × 47,500 |
| Supported | 725 instances / 157 identities (58.61%) |
| Packaged | 219 / 4 (`LargeBlockArmorBlock` 194, `LargeHeavyBlockArmorBlock` 11, `LargeBlockArmorSlope` 4, `LargeBlockSmallHydrogenThrust` 10) |
| Runtime vanilla | 506 / 153 (15 multi-cell; 0 definition-level Subparts among supported) |
| Unsupported known | 0 / 0 |
| Unknown unresolved | 512 / 26 (41.39%) |

Root causes (unresolved only):

| Cause | Instances | Unique | % blocks | % unresolved |
| --- | ---: | ---: | ---: | ---: |
...
Did not appear: Small Grid, Subparts, multi-model, missing model, MWM-only, missing/ambiguous FBX, unsupported FBX format, modded, pathological Size.

Hypothetical classification coverage only: 58.61% now; 98.46% after CubeTopology; 99.76% after parse; 100% after empty-subtype. Those causes were not implemented.

Production parser still accepts ShipBlueprint only. Survey wrap of a single Large Grid Prefab is intake-only. Salvador production parse of the wrap fails closed on empty `SubtypeName` at `CubeBlocks[297]`; survey extract records the three empty-subtype defaults distinctly and does not invent SubtypeIds.

Big Red contrast (same pipeline): SHA-256 `420a671374666725e88ee117e1dac668fc1ee455081c0ac90ba6ce4ff122b895`; preflight 136 / supported 136 / unknown 0 / unsupported 0 / fillers 0. Survey classification packaged 81 / runtime 55 / unknown 0.

Optional Salvador SolidWorks assembly was not run (1,237 blocks / 512 unresolved would not classify additional identities).

Recommended next decision if the human later authorizes exactly one implementation unit: CubeTopology native constructions, starting with leftover `Slope2Base` / `Slope2Tip` and other planar Sides-driven tokens; distinguish RoundSlope / RoundCorner as needing broader curved primitives. That unit is not created and is not started. Next executable unit remains none.

Durable report: [S2C-11.12.1_REAL_BLUEPRINT_COMPATIBILITY.md](../surveys/S2C-11.12.1_REAL_BLUEPRINT_COMPATIBILITY.md). Survey package `se2cad.survey` is classification/reporting only. Ordinary verification excluding untracked Small Grid WIP, with `SE2CAD_GAME_ROOT` / `SE2CAD_SDK_ROOT` unset: `.\.venv\Scripts\python.exe` suite 662 tests, 12 skipped, OK.

| Check | Result |
| --- | --- |
| Packaged catalog | 9 entries unchanged |
| Leftover set | unchanged; `Slope2Base` remains residual automatable |
| CubeTopology / Small Grid / OBJ | unchanged / postponed / not introduced |
| Transient runtime records | in-process only; not persisted |
| Big Red preflight | 136 / supported 136 / unknown 0 / unsupported 0 / `all_supported=true` |
| Big Red permissive policy | 136 IR; `filler_count=0` |
| Ordinary suite | 662 tests, 12 skipped, OK (env unset; Small Grid WIP excluded) |
| Keen assets / generated CAD committed | none |
| Commit / tag / push / deploy | none |

Distinct assessment [below](#qualitysecurity-assessment-s2c-11121).

### 2026-09-11 — S2C-11.11.1 QUALIFIED

Human-authorized demand-driven Large Grid multi-cell TriangleMesh materialization after S2C-11.10.1 was QUALIFIED and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not start Small Grid. Did not expand CubeTopology. Did not add OBJ export, modded-block support, or a generic subpart/animation framework. Did not special-case Big Red subtype names in production. Did not redesign the demand-driven vanilla resolver/materializer. Did not bulk-expand the packaged catalog. Did not invent or begin a later unit. Did not commit, tag, or push. Did not commit Keen FBX or derived SLDPRT.

The only eligibility change is removal of the blanket Size==1×1×1 runtime gate. An identity still becomes supported only when the already-qualified resolver conditions hold: exact vanilla definition, Large Grid, valid positive Size with axis ≤ 32, TriangleMesh, no CubeTopology, no definition-level Subparts, one primary Model, contained uniquely resolved official SDK FBX in a format already supported by S2C-11.9.1, and an available materializer. Missing or ambiguous SDK sources remain unresolved. A later source/conversion/SolidWorks failure after support is granted remains a hard failure, not filler.

Resolved Size and ModelOffset from the exact vanilla definition become a transient `BlockPlacementDefinition` overlay consumed by `canonical_block_from_parsed`. `ParsedBlock` stays blueprint-only. Transform code does not read Game Content. Definition Center is not parsed and is not CAD translation. Official SDK model origin is preserved; imported meshes are not recentered. Placement remains the qualified S2C-11.10.1 rule: occupied Max = Min + abs(R · (Size − 1)); translation is occupancy-center millimetres plus one rotated ModelOffset converted once from metres.

Geometry IDs: previously qualified 1×1×1 identities keep `vanilla_lg_1x1x1_<slug>`. Newly supported multi-cell identities use size-neutral `vanilla_lg_<slug>`. IDs are independent of Min, orientation, and absolute roots. Collision with packaged geometry IDs fails closed.

Imported-mesh envelope validation is Size-aware: 1×1×1 keeps the qualified 6.0 m / 2.0 m limits; multi-cell allows the longest occupancy axis plus one Large Grid cell of protrusion. Forgotten ×1000 and absurd scale still fail closed. `chamfer_capable` remains false for imported SDK meshes.

Ordinary verification excluding untracked Small Grid WIP: `.\.venv\Scripts\python.exe` suite 649 tests, 12 skipped, OK.

Targeted live probe under gitignored `generated/s2c-11.11.1-probe` (strict): 7/0/0/0. First run generated four multi-cell IDs (`vanilla_lg_large_block_landing_gear`, `vanilla_lg_large_block_large_hydrogen_thrust`, `vanilla_lg_large_block_radio_antenna`, `vanilla_lg_large_ore_detector`) and reused armor + packaged small H2 thrust; 526.7 s. Two Landing Gear instances shared one SLDPRT. Second run generated nothing; 110.9 s. Name-matched live translations equal IR occupancy centers. Save/reopen succeeded. No blocking modal.

Big Red permissive under fresh gitignored `generated/s2c-11.11.1-bigred`, seeding only already-qualified 1×1×1/armor/thrust parts:

| Check | Result |
| --- | --- |
| Preflight | 136 / supported 136 / unknown 0 / unsupported 0 / fillers 0 |
| Cold generated | five IDs: tank, large H2 thrust, landing gear, radio antenna, ore detector |
| Cold reused | 20 already-qualified IDs |
| Cold elapsed | 1166.3 s |
| Warm generated | none; all 25 demanded IDs reused |
| Warm elapsed | 327.9 s |
| Final components | 136; 0 fillers; 0 substitutions |
| Existing 126 | part identity, transform, orientation, and color unchanged vs S2C-11.10.1 |
| Ten multi-cell live poses | exact occupancy-center millimetres and generic IR rotations |
| Packaged catalog | 9 entries unchanged |
| SolidWorks | RevisionNumber 34.3.2; `started_application` false; document count 0 before and after |
| Modal / COM | no blocking modal; no COM exception |
| Session hygiene | document count returned to baseline |

Exact Big Red live translations (mm): tank idx 5 `(0, 27500, 12500)`; large H2 thrust idx 15/17/34 `(0, 20000, 12500)`, `(0, 20000, 20000)`, `(0, 20000, 5000)`; landing gear idx 20/21/25/28 `(5000, 36250, 12500)`, `(5000, 16250, 12500)`, `(-5000, 36250, 12500)`, `(-5000, 16250, 12500)`; antenna idx 51 `(-7500, 28750, 13750)`; ore detector idx 135 `(5000, 23750, 7500)`.

Official sources (operator-local, not modified, all binary FBX): `LandingGear.FBX`, `HydrogenThrusterLarge.FBX`, `HydrogenTank.FBX`, `Antenna.FBX`, `OreDetector.FBX`. All five ModelOffset values are zero. Large H2 thruster definition Center is not used.

Visual reopen of `generated/s2c-11.11.1-bigred/Big_Red+ffe1ed5b9381.SLDASM`: antenna mast present and long; four C-bracket landing gears at two heights and both signs of X; three large H2 thrusters and the hydrogen tank occupy the expected hull volume; no filler cubes remain; existing armor, letters, conveyors, cockpit, and lights show no unexpected motion.

No `.mwm`, `.fbx`, `.dds`, `.hkt`, or committed CAD. Distinct assessment [below](#qualitysecurity-assessment-s2c-11111).

### 2026-09-10 — S2C-11.10.1 QUALIFIED

Human-authorized CAD-neutral multi-cell placement foundation after S2C-11.9.1 was QUALIFIED and after the human postponed Small Grid. Did not start S2C-13.1.1. Did not enable multi-cell runtime support. Did not relax the S2C-11.8.1 1×1×1 eligibility gate. Did not generate multi-cell SolidWorks parts. Did not change the packaged catalog. Did not start Small Grid. Did not expand CubeTopology. Did not add subtype-specific placement hacks. Did not invent or begin a subsequent resolver/materialization unit. Did not commit, tag, or push.

Chosen architecture: `ParsedBlock` remains blueprint-only. Immutable `BlockPlacementDefinition` (`CellSize` + `ModelOffset` in metres) is supplied to `canonical_block_from_parsed`. `CanonicalBlock` keeps the resulting `(R, t)` only; Size, occupied Max, ModelOffset, and definition Center are not IR fields. The transform engine is deterministic from its inputs and does not search Game Content, inspect SDK files, call the vanilla resolver, or read XML.

Occupied Max is the integer mapping `Min + abs(R · (Size − 1))` with componentwise abs after orientation. Translation is occupancy-center millimetres plus one rotated ModelOffset converted by `MILLIMETRES_PER_METRE` (1000). Half-cell centers stay exact integer millimetres at Large Grid pitch 2500. Definition Center is not a translation input.

1×1×1 plus zero ModelOffset reproduces the qualified cell-center result exactly. Packaged/library 1×1×1 identities use catalog observed Size and explicit zero offset. Unresolved blocks keep the designated 1×1×1 filler placement contract. Runtime vanilla support remains the S2C-11.8.1 1×1×1 gate.

Ordinary verification excluding untracked Small Grid WIP: `.\.venv\Scripts\python.exe` suite 627 tests, 12 skipped, OK.

Big Red read-only (operator blueprint `C:\SE-blueprints\bigred_bp.sbc`, roots `SE2CAD_GAME_ROOT=C:\SE2CAD-SE\Game\Content` and `SE2CAD_SDK_ROOT=C:\SE2CAD-SE\ModSDK\OriginalContent` for the policy-count probe only): 136 / supported 126 / unknown 10 / unsupported 0 / fillers 10. The ten multi-cell instances remain fillers at `Min` cell center. Expected future occupancy-center translations were calculated without granting support and written to gitignored `tmp/generated/s2c-11.10.1/bigred_multicell_expected_transforms.csv`.

| Check | Result |
| --- | --- |
| Fixture SHA-256 | `99c93d199a6dc960918ecd70dcecbb154c16e18d5638d359a279a15140a95b31` unchanged |
| Acceptance 1×1×1 transforms | identical to `cell_center_mm` + existing rotations |
| Packaged catalog | 9 entries unchanged |
| S2C-11.8.1 size gate | still requires 1×1×1 |
| Big Red parse / preflight | 136 blocks; supported 126 / unknown 10 / unsupported 0 |
| Big Red permissive policy | 136 IR instances; 10 fillers at Min cell center |
| Multi-cell CAD generated | none |
| Session hygiene | no SolidWorks live run required or performed |

No `.mwm`, `.fbx`, `.dds`, `.hkt`, or committed CAD. Distinct assessment [below](#qualitysecurity-assessment-s2c-11101).
...
## Quality/security assessment (S2C-11.16.1)

Hypotheses tested after FBX/MWM/definition research, the CAD-neutral frame rule, Blender-host tests, the HydrogenTank envelope failure, live generate/assemble, and the isolated Big Red rebuild. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Occupancy/ModelOffset/IR/Transform2 were the RemoteControl defect | Disproven by S2C-DIAG-REALSHIP-ALIGNMENT-1 and this unit. Transform2 still matches IR after the mesh-frame fix. No production change in those modules. |
| All mesh nodes should be dropped except the parent | Rejected. Official `RemoteControl.mwm` string table includes `Remotecontrol_Large*`, `airtight_corner_*`, and `arrows*`. Battery likewise exports airtight/detail names. |
| Name heuristics should drop airtight/arrows | Rejected. Those names are in official MWM. Frame correction, not exclusion. |
| Rule is a RemoteControl special case | Disproven. No identity names in `sdk_fbx_frame.py`. RemoteControl is one baked+displaced example. |
| Combined-origin-local multi-node files are shifted | Confirmed then remediated. HydrogenTank parent T=(0,0,-3.75) looked baked; combined world was already ±3.86 m. Guard skips neutralization when combined center is origin-local. Recheck: tank neutralized 0, size ≈7.72×7.57×7.72 m. |
| Battery/FrontLight/Symbol/Camera/Container origin or face placement changes | Disproven. Neutralized count 0; after bounds match the prior diagnostic convert JSON. |
| Official SDK FBX is rewritten | Disproven. Conversion writes only under the generated work root. |
| Entire SDK is scanned/converted | Disproven. Demand-driven target FBX only. |
| ModelOffset is baked into the mesh | Disproven. Recipe translation remains (0,0,0) mm; ModelOffset stays a placement-stage value. |
| ×1000 / Rx90 contract changes | Disproven. Focused conversion contract test still requires those flags. |
| Non-deterministic object order | Disproven. Rule corrections are name-keyed; applied list is sorted by name. |
| Hard-coded blueprint or generated paths | Disproven. Production rule uses imported mesh records only. |
| Generated CAD or Keen assets enter Git | Disproven. Artifacts stay under `C:\SE2CAD-generated\`. |
| CubeTopology / Small Grid / OBJ activated | Disproven. Salvador residual remains 191 CubeTopology. Ordinary suite still excludes `tests/test_small_grid.py`. No OBJ path. |
| Facet-normal warning suppressed | Disproven. Production only logs `SE2CAD_STL_IMPORT geometry_id=...` immediately before STL import. FrontLight import was slow; the warning was not hidden. |
| Universal Big Red alignment | Not claimed. Sampled identities match IR and RemoteControl no longer has the proven dual hull. Other unsampled identities were not visually certified. |

Remediated: combined-world origin-local guard after HydrogenTank envelope failure; live test uses `rotation`/`position_mm` and source_index matching instead of a nonexistent `transform` field and zip order.

Accepted residual risks: other dual-frame FBX patterns that are neither baked+displaced nor combined-origin-local stay on the previous all-world join. Helper/collision/debug meshes that official MWM exported remain in the joined body. FrontLight `LoadFile2` can take tens of minutes. First STL imports can be slow. Tracked `tests/test_small_grid.py` remains out of the ordinary suite.

Not claimed: universal vanilla or FBX support; that every real-ship alignment defect is fixed; CubeTopology; Small Grid; OBJ; a next executable unit.

## Quality/security assessment (S2C-11.15.1)

Hypotheses tested after definition-fact extraction, parser/lookup/resolver changes, focused tests, ordinary suite, Salvador/Big Red preflight, the live STL-import remediations, and the S2C-11.15.1-LIVE 8-block generate-then-reuse assemble. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Child-vector parsing is a general child-collection parser | Disproven. `_read_xyz_strings` accepts only Size/ModelOffset attribute form or X/Y/Z children. Mix, extra names, missing axes, empty, and non-numeric fail closed. Min still requires attributes. |
| Duplicate-value coalescing is applied to every repeated field | Disproven. `coalesce_identical_scalar_texts` is used only for `BlockTopology`. `CubeSize` and other scalars still require exactly one. Tests reject duplicate CubeSize. |
| Conflicting duplicates silently pass | Disproven. `[TriangleMesh, Cube]` and empty+non-empty fail closed. |
| Empty subtype is mapped by builder name alone / first match | Disproven. Lookup requires TypeId + Large `CubeSize` + exactly one empty-SubtypeId vanilla definition. Ambiguity raises. Non-empty variants of the same TypeId do not participate. |
| Large/Small definitions are collapsed | Disproven. `lookup_unique_empty_subtype` filters `cube_size`. Small empty counterparts exist and are not used. |
| Modded definitions participate in vanilla identity | Disproven. Index is the configured game-content CubeBlocks tree only. Ordinary tests exclude a second tree. |
| A synthetic SubtypeId leaks into public IR | Disproven. `subtype_id` stays `""`. `CanonicalBlock` has no `object_builder_type`. Component names use already-resolved `geometry_id`. Placement key `empty-type/{TypeId}` is internal. |
| geometry_id collides with packaged library IDs | Disproven. `empty_` infix plus `checked_geometry_id` plus packaged-library collision check. Tests fail closed on collision. |
| Root-order dependence / first file wins | Disproven. Duplicate empty TypeId+CubeSize hits raise. |
| Path traversal / whole-install scan | Disproven. Existing contained model path and CubeBlocks-only index remain. |
| Transient records persist / catalog mutates | Disproven. Packaged catalog still 13 entries. No leftover JSON change. |
| CubeTopology / RoundSlope / RoundCorner / Small Grid / OBJ activated | Disproven. Eligibility still rejects CubeTopology and non-Large. Salvador residual is 191 CubeTopology. Round* stay unresolved. No OBJ path. |
| `object_builder_type` rewritten | Disproven. Parser retains the serialized token. Tests assert GravityGenerator unchanged. |
| Unidentified empty subtype now parses | Disproven. Empty + `MyObjectBuilder_CubeBlock` or omitted type still rejected. |
| Supported builder failure becomes filler | Disproven. Focused test patches generate to raise; `ensure_untreated_canonical_parts` raises. |
| Solid STL import / Import Diagnostics hangs unattended LoadFile2 | Confirmed as a minutes-long unattended `LoadFile2`, then closed. Session-scoped graphics-body + mm + no auto-diagnostics stay in force for the whole generate batch and restore on close. Envelope accepts a coherent graphics-body box. S2C-11.15.1-LIVE imported all seven identities through that path. First-file imports can take many minutes; that is not a modal hang. |
| One or more of the seven identities not actually materialized | Disproven. First-run generated exactly the seven production geometry IDs; each SLDPRT exists under the isolated probe root. |
| Stale generated parts mask first-run generation | Disproven. The live test closes leftover probe documents, `rmtree`s the probe root, and asserts the seven SLDPRTs are absent before assemble. |
| Repeated identity generates twice / warm run regenerates | Disproven. Two `LadderShaft` components share one part file. Warm run generated none and reused all seven. |
| Empty-subtype identities collide or lose identity after reopen | Disproven. Distinct `empty_` geometry IDs. Reopened part references and `subtype_id=""` remain. No synthetic SubtypeId. |
| Multi-cell OxygenTank/OxygenGenerator placed at Min cell | Disproven. IR and reopened translations match occupancy-center and differ from Min-cell center. |
| Graphics-body validation accepts empty/invalid or rejects valid imports | Disproven as a live miss. Production generate still runs `assert_imported_mesh_envelope` on save and reopen. Part files are 637,858–1,484,222 bytes. |
| Import preference changes leak beyond session/test | Disproven. Test snapshots STL prefs before assemble and requires the same triple after warm run. |
| Stale SolidWorks host mistaken for healthy host | Partial. `GetActiveObject` fails on this host; `Dispatch` attaches (`started_application=true`) and RevisionNumber 34.3.2 / document count 0 are usable. The host is leftover from earlier work and ignores ROT registration. |
| Failed supported builder silently becomes filler | Disproven. STRICT convert fillers 0; materialization `substituted_geometry_ids` empty. |
| Modal dialog hidden by timeout rather than resolved | Disproven. Visible=false `LoadFile2` completed; no leftover modal; document count returned to 0. |
| RPC failure ignored | Confirmed as a residual, not a failed assemble. After save, `close_doc` `GetTitle` can print `RPC_E_DISCONNECTED` (0x80010108); existing `_title` swallows it and reopen/warm still succeed. An extra post-assemble seven-part OpenDoc sweep left `vanilla_lg_1x1x1_large_block_sci_fi_wall.SLDPRT` open and raised RPC on CloseDoc; that sweep was removed from the live test. |
| Assembly reopened from the wrong generated root / old cached SLDPRTs | Disproven. Isolated `C:\SE2CAD-generated\s2c-11.15.1-live`. Reopened paths are relative to that root. |
| SDK/Game roots hard-coded / generated CAD or Keen assets enter Git | Disproven. Operator env/local-config only. Probe CAD is outside the repo. No `.fbx`/`.mwm`/`.SLDPRT`/`.obj` tracked adds. |
| CubeTopology / Small Grid / OBJ appear | Disproven. Salvador residual remains 191 CubeTopology only. Ordinary suite still ignores `tests/test_small_grid.py`. No OBJ path. |
| Big Red regresses | Disproven. Preflight remains 136 / 136 / 0 / 0. |

Remediated: IR/policy placement-key helpers stay CAD-neutral (no `se2cad.vanilla` import). Unusable-hit CubeSize no longer aborts a whole SBC. STL import preferences are session-scoped graphics-body. Envelope no longer rejects a valid graphics-body box as “no usable body.” The live test no longer re-opens all seven parts after assemble. Ordinary suite after live closure: 704 passed, 19 skipped, OK.

Accepted residual risks: this SolidWorks host does not register in the ROT (`GetActiveObject` fails). Post-save `GetTitle` can emit `RPC_E_DISCONNECTED` while documents close; assemble/reopen still succeed. Leftover SLDWORKS processes can ignore `ExitApp`. First STL `LoadFile2` on a quiet host can take many minutes. Discovery tests still fail if a real SDK root without `Data/CubeBlocks` is left in the environment. Tracked `tests/test_small_grid.py` remains out of the ordinary suite. A later official mesh that cannot form a coherent envelope still fails closed.

Not claimed: general empty-subtype support; CubeTopology support; Small Grid; OBJ; that remaining 191 Salvador unknowns are anything but CubeTopology; a next executable unit.

## Quality/security assessment (S2C-11.14.1)

Hypotheses tested after definition extraction, 2018/ModAPI source inspection, binary-FBX classification, rotation-equivalence of qualified families, Salvador re-survey, Big Red preflight, ordinary suite, and documentation existed. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Topology inferred only from subtype names | Disproven. Inventory and families come from observed `CubeTopology` tokens, Sides stems, mounts, and `MirroringBlock`. No solid was granted from a name. |
| 2018 Keen source treated as current authority for later tokens | Disproven. Report records the 2018 table ends before HalfSlopeInverted and later tokens. ModAPI enum presence is not a vertex table. |
| Mesh appearance confused with logical CubeTopology solid | Disproven. Official FBX was classified binary only. No vertices were taken from tessellation. Mesh is validation presence, not a primitive. |
| Sides treated as a universal solid grammar | Disproven. Architecture and report reaffirm Sides as mount/texture plates. No interpreter was added. |
| Mirrored TransitionTip treated as a legal rotation | Disproven as a grant. Reciprocal `MirroringBlock` and Front/Back mounts are HIGH_CONFIDENCE chirality only. No `IMPLEMENTATION_READY_SEPARATE_MIRROR`. No det −1 transform. |
| Determinant −1 transform assumed | Disproven. IR rotation contract untouched. Slope2Tip X-reflection is proper-rotation equivalent; that result was not transferred to later tokens. |
| Coordinate-system / FBX-MWM / mm-m / half-cell errors in a new solid | Not applicable. No new candidate solid was published as PROVEN. Qualified control volumes still match `36/12/24 h³`. Discarded `HYP_SlopeCapYLe0` is recorded as invalid. |
| Non-manifold / winding / duplicate-face candidate polyhedra published | Disproven. No remaining-token polyhedron was added. Qualified solids re-checked closed. |
| Curved geometry accidentally included | Disproven. RoundSlope/RoundCorner classified `OUT_OF_SCOPE`. Round plates (`SlopeRoundPlate`, `CornerRoundTriangle*`) recorded as exclusion evidence. |
| Small Grid accidentally included | Disproven. 54 Small counterparts were listed only as exclusion proof. S2C-13.1.1 stays postponed. |
| StandaloneBox generalized globally | Disproven. InteriorWall omitted `BlockTopology` remains a bounded identity fact. Production lookup unchanged. Report forbids implementing InteriorWall as Box. |
| Copied Keen assets / large source tables / extracted geometry enter Git | Disproven. Report cites locations and small facts. Harness JSON/FBX stay under gitignored `tmp/`. No `.fbx`/`.mwm`/`.SLDPRT` tracked adds. |
| Production support accidentally granted / catalog or leftover mutated | Disproven. `AUTOMATABLE_CUBE_TOPOLOGIES` unchanged. Catalog still 13 entries. Leftover leftovers still `[]`. Salvador `support_granted=false`. Supported count unchanged at 1,027. |
| HIGH_CONFIDENCE counted as solved | Disproven. Payoff uses only PROVEN: +0 instances. |

Remediated: none required. Investigation defects were avoided rather than patched after a support grant.

Accepted residual risks: later-token solids remain unknown without post-2018 tables or an authorized mesh-characterization unit. Discovery tests still fail if a real SDK root without `Data/CubeBlocks` is left in the environment. Tracked `tests/test_small_grid.py` remains out of the ordinary suite because Small Grid production symbols are absent.

Not claimed: remaining planar CubeTopology support; that later tokens are safely guessable; that official meshes are redistributable; a next executable unit.

## Quality/security assessment (S2C-11.13.1)

Hypotheses tested after definition inspection, construction/catalog/leftover bindings, ordinary suite, live part/fixture generation, Salvador survey, Big Red preflight, remediations, and documentation existed. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Subtype-name special casing masquerades as geometry classification | Disproven. Bindings are `PLANAR_CUBE_TOPOLOGY_BINDINGS` from observed `CubeTopology` tokens. Ordinary tests require definition facts and reject name-only inference. |
| All CubeTopology is granted | Disproven. `AUTOMATABLE_CUBE_TOPOLOGIES` is the prior four plus Slope2Base/Slope2Tip/HalfBox. RoundSlope/unknown tokens fail closed. Salvador still has 191 CubeTopology unresolved. |
| Omitted BlockTopology is granted globally | Disproven. `LargeBlockInteriorWall` remains unresolved. Ordinary tests assert omitted BlockTopology does not grant support. |
| RoundSlope/RoundCorner enter the supported set | Disproven. Both remain `CUBETOPOLOGY_NOT_SUPPORTED` (44+32). Catalog has neither identity. |
| Small Grid is activated | Disproven. Packaged identities are Large. Small Slope2Base stays unresolved. S2C-13.1.1 stays postponed. |
| Sides data is treated as a universal solid grammar | Disproven. Architecture records Sides as mount/texture panels. No CubeTopology interpreter was added. |
| Heavy/light HalfBox falsely share a `geometry_id` | Disproven. Catalog uniqueness keeps `large_half_armor_block` and `large_heavy_half_armor_block`. They share only the HalfBox construction. |
| Mirrored parts use determinant −1 | Disproven. No mirrored identity was bound. Existing 24 rotations remain det +1. Fixture Right/Up and Down/Forward were +1. |
| Definition Center is used as translation / occupancy-center changed | Disproven. Placement modules were not rewritten. 1×1×1 IR translations remain `Min * pitch`. |
| Half-cell dimensions or local origin are wrong | Disproven. HalfBox max Y = 0; volumes are `24 h³`; Slope2Tip is not a box. Live SW volumes match the plan. |
| Builder failure silently becomes filler | Disproven. Existing materialize fail-closed tests remain. Qualified generation failure raises; the fixture used STRICT with 0 fillers. |
| Stale cached SLDPRTs hide builder defects | Disproven. Live tests used fresh per-unit roots and rmtree before generate. |
| Whole-install eager materialization / catalog bulk expansion | Disproven. Default generate set is the original four. Catalog grew by the four proven identities only. |
| SDK TriangleMesh / existing armor constructions regress | Disproven. Ordinary library/catalog/vanilla tests remain green. Big Red preflight 136/136. |
| Keen assets or generated CAD enter git | Disproven. Generated roots are outside git (`C:\SE2CAD-generated`, `tmp/`). No `.fbx`/`.mwm`/`.SLDPRT` tracked adds. |
| Accidental parallel SW session corrupts qualification | Confirmed as environment, then contained. A leftover `SE2CAD_SOLIDWORKS_INTEGRATION=1` ordinary-suite run collided with a 302-block extract and killed COM. Official ordinary suite was re-run with that variable unset. Live part and 6-block fixture evidence were collected on a healthy host before that collision. Full Salvador reopen was not retried. |

Remediated: targeted-fixture test looked up `after_reopen[2]` by IR order; SolidWorks component order is not IR order. Test now keys by `grid_min` like the acceptance fixture. A hung 16-hour SolidWorks host that could not `OpenDoc` was recycled with empty-document `ExitApp`. Ordinary suite after remediation, env unset: 685 tests, 15 skipped, OK.

Accepted residual risks: 115 remaining Salvador planar instances have no post-2018 topology tables and stay unresolved. InteriorWall omitted BlockTopology is not a global rule. Sides remain mount metadata. Full Salvador SolidWorks reopen was not completed after the COM collision; the 6-block fixture is the live placement evidence. Discovery tests still fail if a real SDK root without `Data/CubeBlocks` is left in the environment. Untracked `tests/test_small_grid.py` remains out of scope.

Not claimed: CubeTopology support; Small Grid; OBJ; generic subparts; that remaining planar tokens are safely guessable; that derived CAD is redistributable; a next executable unit.

## Quality/security assessment (S2C-11.12.1)

Hypotheses tested after survey classification, ordinary suite, Big Red preflight regression, catalog/leftover inspection, and documentation existed. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Survey grants runtime support | Disproven. `se2cad.survey` classifies existing `resolve_vanilla_geometry` outcomes. CubeTopology, empty-subtype, and parse-unsupported identities remain `UNKNOWN_UNRESOLVED`. Ordinary tests assert CubeTopology does not become supported and `support_granted=false`. |
| Packaged catalog mutates | Disproven. `large_grid_armor.json` still has 9 entries. Leftover set still records `Slope2Base` as residual automatable. No catalog JSON change. |
| Transient records persist | Disproven. Survey does not write catalog or leftover JSON. Runtime binds remain the existing in-process resolver cache. |
| Scanning outside configured roots | Disproven. Definition lookup uses existing targeted subtype lookup under `try_load_game_content_root`. SDK probes stay under `try_load_sdk_root` with `relative_to` containment. Inventory was two bounded Prefab folders, not a whole-install scrape. |
| Path traversal / unsafe XML | Disproven. Survey intake rejects doctype/entity/xinclude. Extra-definition reads resolve then `relative_to` the configured game root. |
| Unbounded memory / whole-install scan | Disproven. Classification is one operator-selected document plus one targeted lookup per unique SubtypeId. |
| Small Grid / CubeTopology / OBJ activated | Disproven. Eligibility still requires Large + TriangleMesh. CubeTopology remains unresolved. No OBJ path was added. S2C-13.1.1 stays postponed. |
| Modded identities treated as vanilla | Disproven. Missing exact vanilla definition maps to `MODDED_OR_NONVANILLA`. Salvador had none. |
| Unknown conflated with unsupported | Disproven. Packaged `unsupported` is `UNSUPPORTED_KNOWN`; resolver miss is `UNKNOWN_UNRESOLVED`. Salvador unsupported known is 0. |
| Percentages use the wrong denominator | Disproven. Ordinary test asserts block-count and unresolved-instance denominators. Salvador 725/1237=58.61; 493/512=96.29. |
| Instance vs unique counts confused | Disproven. Report and STATE tables keep both. CubeTopology is 493 instances / 19 identities. |
| Survey-ship names hard-coded in production | Disproven. Ordinary test forbids `RST6Salvador` / `Big Red` / `bigred` in `src/se2cad/survey`. |
| Prefab wrap becomes production parse support | Disproven. Production parser still requires ShipBlueprint. Wrap is survey-only and recorded in warnings. |
| Empty SubtypeName invents a default identity | Disproven. Survey records `(empty SubtypeName)/MyObjectBuilder_*` as unresolved. Production parser still fails closed. |
| Big Red support semantics changed | Disproven. Final preflight remains 136 / 136 / 0 / 0 / 0. |
| Keen assets or generated CAD enter git | Disproven. Machine output is under gitignored `tmp/`. Durable report contains subtype names and paths only. |
| Stale operator env affects ordinary tests | Verified as pre-existing isolation: discovery tests scan a configured SDK root when `SE2CAD_SDK_ROOT` is set. Ordinary suite for this unit was run with those variables unset. Not a survey support grant. |

Accepted residual risks: Salvador extents are Min-cell span, not Size occupancy, because production parse of the wrap fails on empty `SubtypeName`. Prefab wrap is not production Prefab support. No second ship was fully classified; Salvador’s top cause is 96.29% of unresolved, so another ship would not change the recommendation. No Salvador SolidWorks assembly was run. Hypothetical coverage assumes every instance of a solved cause would become a correct CAD solid; Round* tokens may need more than a planar cut. Untracked `tests/test_small_grid.py` remains out of scope.

Not claimed: CubeTopology support; Small Grid; OBJ; MWM decoding; subpart/animation/mechanical assembly; Prefab as a production document type; that derived CAD is redistributable; that the recommended CubeTopology direction is an authorized next unit.

## Quality/security assessment (S2C-11.11.1)

Hypotheses tested after eligibility, placement overlay, geometry-ID, envelope, ordinary suite, live probe, Big Red cold/warm assemble, remediations, and documentation existed. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Small Grid is activated | Disproven. Eligibility still requires CubeSize Large. Ordinary Small Grid cases remain unresolved. S2C-13.1.1 stays postponed. |
| CubeTopology is expanded | Disproven. CubeTopology identities still return unresolved. Ordinary CubeTopology tests remain green. |
| Bad Size bounds fail open | Disproven. Zero/negative Size fail closed; axis > 32 is unresolved; malformed Size still fails closed. |
| Pathological occupancy or ModelOffset units/double-apply | Disproven. Overlay carries definition Size/ModelOffset once. Transform still uses the S2C-11.10.1 contract. Live Big Red poses match those translations exactly. |
| Definition Center enters CAD translation | Disproven. Center is not parsed. Focused ordinary test and large-H2-thruster occupancy `(0, 20000, *)` vs Center `(1,1,2)` both hold. |
| Geometry ID depends on Min or orientation, or collides | Disproven. 1×1×1 IDs keep `vanilla_lg_1x1x1_*`. Multi-cell IDs are size-neutral `vanilla_lg_*`. Collision with packaged IDs fails closed. Light still resolves as `vanilla_lg_1x1x1_large_block_front_light`. |
| Old 1×1×1 cache is invalidated | Disproven. Big Red reused all seeded `vanilla_lg_1x1x1_*` parts; none were regenerated. |
| Stale part reuse after identity change | Disproven. New multi-cell IDs were generated once and reused; they do not overwrite 1×1×1 filenames. |
| Source/generated path escape or ambiguous stem | Disproven. Existing contained-SDK mapping remains. Ambiguous/missing SDK stays unresolved. |
| Support granted before usable source/builder | Disproven. Resolve still requires a uniquely resolved usable SDK FBX before the runtime record is registered. |
| Supported builder failure becomes filler | Disproven. Ordinary builder-failure test stays hard-fail. Big Red had 0 fillers after support. |
| Size-aware envelope too strict or too loose | Disproven for the qualified set. Antenna ~15 m and landing-gear protrusion were accepted; 1×1×1 6 m/2 m limits remain; forgotten-scale and absurd-scale ordinary tests still fail. |
| Binary or ASCII FBX regression | Disproven. Ordinary S2C-11.9.1 tests remain green. All five Big Red multi-cell sources are binary FBX on the existing path. |
| Transient bindings persist / catalog mutates | Disproven. Packaged catalog still 9 entries. Runtime overlays are in-process only. No catalog JSON change. |
| Big Red subtype-specific production branch | Disproven. Production `src/` does not name the five identities. |
| Keen assets or generated CAD enter git | Disproven. Generated roots and tmp runners are gitignored. `git status` shows no `.fbx`/`.SLDPRT`/`.SLDASM` tracked adds. |
| Modal / leaked documents | Disproven. No blocking modal. Document count 0 before and after live session snapshots and post-inspect. |
| Existing 126-component regression | Disproven. Multiset of part + transform + color vs S2C-11.10.1 is unchanged. |

Accepted residual risks: later-session FeatureManager Name2 reads may show part stems; assemble-time and same-session reopen still name-match IR, and later-open verification used part+transform identity. Ordinary discovery tests are sensitive to a leftover `SE2CAD_SDK_ROOT` in the process environment; that is pre-existing test isolation, not a resolver grant. Envelope protrusion is one Large Grid cell; a future official mesh that protrudes farther would fail closed until a later authorized limit change. Untracked `tests/test_small_grid.py` remains out of scope.

Not claimed: Small Grid; CubeTopology expansion; OBJ; MWM-only support; modded blocks; composite/subpart or animation frameworks; whole-install pre-materialization; universal FBX; that derived CAD is redistributable.

## Quality/security assessment (S2C-11.10.1)

Hypotheses tested after the placement value objects, transform functions, IR/policy wiring, ordinary suite, Big Red read-only probe, remediations, and documentation existed. Outcomes:

| Hypothesis | Outcome |
| --- | --- |
| Size axes are swapped or reordered by orientation | Disproven. Local Right/Up/Back Size is rotated first; AABB dimensions are a permutation of Size across all 24 orientations and the property set. |
| Signed rotation is applied after abs | Disproven. `occupied_max` applies `R` then componentwise `abs`. Backward/Down landing-gear mapping ` (0,1,2) → (0,-1,-2) → (0,1,2)` is tested. |
| Half-cell centers are truncated | Disproven. Occupancy center uses exact `(min+max)*pitch/2` integer arithmetic. Landing-gear Y=6.5 is 16250 mm. Non-integer millimetre results fail closed. |
| Large/negative grid coordinates lose precision | Disproven. Max and occupancy use integers only. Negative Min cases are tested. |
| Definition Center is used in CAD translation | Disproven. `placement_translation_mm` has no Center parameter. Thrust occupancy `(0,8,5)` differs from a Center `(1,1,2)` guess. |
| ModelOffset uses wrong axes, units, Size, or is applied twice | Disproven. Keen metres × 1000, rotated once by `R`, added to occupancy center. Float metres are rejected. 3×3×3 vs 1×1×1 share the same offset contribution. |
| Game-content leaks into the transform engine | Disproven. `se2cad.transform` and `se2cad.ir` do not import vanilla/discovery/solidworks and do not mention `SE2CAD_GAME_ROOT` / `game_root`. |
| Multi-cell runtime support was activated | Disproven. `eligibility_reason` still requires 1×1×1. Big Red remains 126 supported / 10 unknown / 0 unsupported / 10 fillers. Those ten IR poses stay `Min` cell center. |
| Unknown blocks are silently assigned Size=1 as a definition fact | Disproven. Unresolved blocks receive the named filler 1×1×1 contract, not a guessed definition Size. Packaged identities use catalog observed Size. |
| Acceptance transforms changed | Disproven. Fixture SHA-256 unchanged; all 24 IR translations equal `cell_center_mm`. |
| Orientation determinant regression | Disproven. Existing 24-orientation orthonormal +1 tests still pass. |
| CanonicalBlock schema / serialization drift | Disproven. Field names unchanged. Two IR builds of the fixture produce identical ordered payloads. |
| Subtype-specific placement hacks | Disproven. Transform/IR source does not name the five multi-cell identities. |
| SolidWorks types in CAD-neutral modules | Disproven. Import scans and CanonicalBlock annotations remain backend-free. |
| Invalid Size or pitch fails open | Verified then remediated. Non-`CellSize` values and non-positive pitch now fail closed with typed errors instead of `AttributeError` / `InvalidBlockSizeError` misuse. |

Accepted residual risk: runtime-supported catalog-unknown identities still use the qualified 1×1×1 placement contract because the S2C-11.8.1 gate admits only that Size and runtime records do not yet carry ModelOffset. A later authorized eligibility change must supply resolved Size/ModelOffset or 1×1×1 placement would be wrong. Ordinary suite Big Red policy counts skip when game/SDK roots are unset; the 126/10 evidence in this session used operator-local roots and is not an install-free claim. Untracked `tests/test_small_grid.py` remains out of scope.

Not claimed: multi-cell runtime support; Big Red filler-free; Small Grid; CubeTopology expansion; that derived CAD is redistributable; that definition Center is used for placement.
