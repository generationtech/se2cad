...
7. **SolidWorks is the first backend**, not the only conceivable backend. Do not rename core abstractions to imply SolidWorks exclusivity. Core parser, catalog, IR, transforms, library, and statistics stay backend-neutral.
